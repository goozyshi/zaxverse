---
title: How to update dependencies of Zaxverse
author: Sat Naing
...
tags:
  - FAQ
description: How to update project dependencies and Zaxverse template.
---

Updating the dependencies of a project can be tedious. However, neglecting to update project dependencies is not a good idea either 😬. In this post, I will share how I usually update my projects, focusing on Zaxverse as an example. Nonetheless, these steps can be applied to other js/node projects as well.
...
## Updating Zaxverse template

Like other open-source projects, Zaxverse is evolving with bug fixes, feature updates, and so on. So if you’re someone who is using Zaxverse as a template, you might also want to update the template when there’s a new release.
...
If you’re someone who only updates the bare minimum of the template, it should be okay to replace everything with the latest Zaxverse except the above files and directories. It’s like pure Android OS and other vendor-specific OSes like OneUI. The less you modify the base, the less you have to update.
