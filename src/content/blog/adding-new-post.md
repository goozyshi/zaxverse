...
title: Adding new posts in Zaxverse theme
...
tags:
  - docs
description:
  Some rules & recommendations for creating or adding new posts using Zaxverse
  theme.
---

Here are some rules/recommendations, tips & ticks for creating new posts in Zaxverse blog theme.
...
Title and description (excerpt) are important for search engine optimization (SEO) and thus Zaxverse encourages to include these in blog posts.
...
Here are some recommendations, tips & ticks for creating new posts in Zaxverse blog theme.
...
There's one thing to note about headings. The Zaxverse blog posts use title (title in the frontmatter) as the main heading of the post. Therefore, the rest of the heading in the post should be using h2 \~ h6.
...
> Since Zaxverse v1.4.0, OG images will be generated automatically if not specified. Check out [the announcement](https://astro-paper.pages.dev/posts/dynamic-og-image-generation-in-astropaper-blog-posts/).
